...
#define DEVICE_NAME "PsycheBLE_WaveMask_G5.3B" /**< Name of device. Will be included in the advertising data. */
...
static void on_adv_evt(ble_adv_evt_t ble_adv_evt)
{
	...
	switch (ble_adv_evt)
	{
		case BLE_ADV_EVT_FAST:
			break;
		case BLE_ADV_EVT_IDLE: //Advertising Timeout
			ble_adv_restart(); //Advertising Restart
			//sleep_mode_enter();	//Enter Sleep And RebootMCU
			break;
		default:
			break;
	}
